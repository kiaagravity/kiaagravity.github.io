...
0. 最后，我有个不情之请的要求：<font color="blue"><b>跟我签本研表格前，需要曾经在组会做过一次文献报告（>=10min）</b></font>
  - 可以自己选一个简单的文献讲
...
<big> **附：可能的课题列表（last update: Oct 31, 2021）**

- 引力波波形的分析与比较（概率统计、编程基础）
- 引力波的极化模式研究（需要广义相对论知识）
- 用脉冲星测时检验引力理论
  - 宇宙中是否存在特殊的参考系？
  - 引力三体系统和等效原理（编程基础）
  - 强引力场与洛伦兹对称性（基本场论知识）
  - 超大质量黑洞的自旋动力学（需要广义相对论知识）
- 地球自旋演化与洛伦兹对称性
- 其他课题
